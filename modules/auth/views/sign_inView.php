    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $config['base_url']; ?>public/admin_accounts/css/style__dangnhap.css" />
        <title>SignIn</title>
    </head>
    <style>
.error {
                ...
                <div class="khoinhap">
                    ...
                    <form action="" method="POST" class="formchung">
                        <div class="form username">
                            ...
                            <p class="desc error"><?php echo isset($error['username']) ? $error['username'] : ''; ?></p>
                        </div>
                        <div class="form password">
                            <label class="label">Password</label>
                            <input type="password" name="password" class="input" />
                            <p class="desc error"><?php echo isset($error['password']) ? $error['password'] : ''; ?></p>
                        </div>


                </div>
                <div class="khoibtn">
                    <a href="<?php echo $config['base_url']; ?>?mod=auth&controller=auth&action=sign_up" class="link">
                        <button class="btn back" type="button">
                            <!-- <svg xmlns=" http://www.w3.org/2000/svg" class="svg" fill="currentColor"
                            viewBox="0 0 512 512">
                            <path
                    ...
                    <button class="btn next" type="submit" name="btn-submit">
                        <span href="" class="link">Next</span>
